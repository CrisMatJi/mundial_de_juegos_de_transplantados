...
const teamFlag = (name: string) => ({ 'Estados Unidos': '🇺🇸', Irlanda: '🇮🇪', México: '🇲🇽', Francia: '🇫🇷', Chile: '🇨🇱', Inglaterra: '🏴', Gales: '🏴' }[name] ?? '🌍')
