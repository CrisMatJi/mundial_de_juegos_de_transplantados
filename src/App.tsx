    ...
    <main className="app-shell">
      ...
      <section className="content-wrap">
        ...
        <div className="dashboard-grid">
          ...
          <aside className="panel live-panel"><div className="panel-heading"><div><p className="section-kicker">SEÑAL OFICIAL</p><h2>Ahora en directo</h2></div><span className="on-air"><Radio size={13} /> ON AIR</span></div><div className="video-frame"><div className="video-unavailable"><CirclePlay size={38} /><strong>España · Chile</strong><span>YouTube no permite incrustar este directo aquí.</span><a href="https://www.youtube.com/@WorldTransplantGames/live" target="_blank" rel="noreferrer">Ver emisión en YouTube <ExternalLink size={14} /></a></div></div><div className="live-footer"><Tv size={17} /><span><strong>Canal oficial WTGF</strong><small>Transplant Football World Cup 2026</small></span><a href="https://www.youtube.com/@WorldTransplantGames/live" target="_blank" rel="noreferrer" aria-label="Abrir canal de YouTube"><ArrowUpRight size={17} /></a></div></aside>
        </div>
